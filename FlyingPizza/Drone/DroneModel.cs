...
namespace FlyingPizza.Drone
{
    ...
    public sealed record DroneRecord(int FleetNumber, string Id, Point Location, string State)
    {
        // Creates a DroneRecord from the given DroneModel
        public static DroneRecord From(DroneModel model)
        {
            return new(model.BadgeNumber, model.Id, model.Location, model.Status.ToString());
        }
    }
    public class DroneModel : ComponentBase
    {
        ...
        // The unique id generated by MongoDB for a drone
        public string Id { get; set; }
        
        // Constructor
        public DroneModel(int badgeNumber, Point location, string Id = "")
        {
        ...
        {
            return new(record.FleetNumber, record.Location, record.Id);
        }
        ...
        private async Task RegisterDrone()
        {
            ...
            var task = RestSvc.Put(Url, DroneRecord.From(this));
