...
public class FleetRepository : IFleetRepository
{
    ...
    public async Task<Dictionary<string, string>> GetAllAddresses() =>
        Enumerable.ToDictionary<DroneRecord, string, string>((await _collection.Find(_ => true).ToListAsync()), droneRecord => droneRecord.Id, droneRecord => droneRecord.DroneIp);
